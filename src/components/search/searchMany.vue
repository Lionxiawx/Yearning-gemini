<template>
    <Form inline ref="queryForm" :model="find">
        ...
        <FormItem label="上线:" prop="is_pub">
            <Select v-model="find.is_pub" placeholder="请选择" @on-change="queryData()">
                <Option  :value="1" :key="1" >是</Option>
                <Option  :value="0" :key="0" >否</Option>
            </Select>
        </FormItem>
        <FormItem label="删除:" prop="is_del">
            <Select v-model="find.is_del" placeholder="请选择" @on-change="queryData()">
                <Option  :value="1" :key="1" >是</Option>
                <Option  :value="0" :key="0" >否</Option>
            </Select>
        </FormItem>
        <FormItem label="bug类型:" prop="bug_type">
            <Select v-model="find.bug_type" placeholder="请选择" @on-change="queryData()" >
